...
<head>
    ...
    <title>ChangNing</title>
    <!-- Google Font -->
    <link href='resources/css/fonts_Dosis.css' rel='stylesheet' type='text/css'>
    <link href='resources/css/fonts_Montserrat.css' rel='stylesheet' type='text/css'>
    <!-- Font Awesome -->
	              ...
	              <div class="container">
	                ...
	                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	                  <ul class="nav navbar-nav navbar-right">
	                    ...
	                    <li><a href="#SERVICE">Bulletin Board</a></li>
	                    <li><a href="#ABOUT">Record</a></li>
	            ...
	            <div class="container">
	                <div class="row">
	                    <div class="col-md-12 text-center">
                            ...
                            <a href="#SERVICE"><img src="resources/images/scroll.png" alt=""></a>
	                            <h4>Scroll Down</h4>
	                        </div>
	                    </div>
	                </div>
    ...
    <section class="work_area" id="WORK">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="resources/images/w1.jpg" alt="">
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="resources/images/w2.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="resources/images/w3.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
            ...
            <div class="row pad_top">
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="resources/images/w4.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image">
                        <img src="resources/images/w5.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
                ...
                <div class="col-md-4 no_padding">
                    <div class="single_image last_padding">
                        <img src="resources/images/w6.jpg" alt="">
                        <div class="image_overlay">
                            <a href="">View Full Project</a>
                            <h2>drawing</h2>
                            <h4>with pencil colors</h4>
